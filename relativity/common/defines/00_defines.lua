NDefines = {
	...
	NAI = {
		...
		MINERAL_BUILDING_BUDGET_FRACTION = 0.30,-- AI will spend this fraction of their stored minerals on buildings (used for spaceport instead when it needs a new spaceport)
		...
		MIN_MINERALS_STORED_BUILDINGS = 150,		-- Minerals AI will store for buildings when it does not need more
		...
		MIN_MINERALS_STORED_COLONIES = 0,			-- Minerals AI will store for colonies when it does not need more		
		...
		POP_FOOD_MIN = 50,						-- AI should always prioritize to get more food when planet food tot is below this value
