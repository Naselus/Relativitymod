...
NDefines = {
	...
	NGameplay = {
		...
		LEADER_ADMIRAL_FLEET_COMBAT_BASE_EXPERIENCE					= 35, -- Leader Admiral base experience from fleet combat
		...
		LEADER_SCIENTIST_LEADING_RESEARCH_FIELD_EXPERIENCE			= 5,
...
--		ETHOS_UNIFORM						= 10,	-- Uniform ethos results in this opinion value
		...
		CORE_SECTOR_SYSTEM_CAP					= 75,	-- Too many planets in core sector will apply modifier inefficient_planet_management.
	...
	NPop = {
		...
		FOOD_SURPLUS_BASE_GROWTH			= 0.5,	-- Amount to grow if there is a surplus
		...
		MAX_REVOLT_SLAVE_HAPPINESS 			= 0.25,	-- Maximum happiness for revolt risk
		MAX_REVOLT_SLAVE_HAPPINESS_LEVEL 	= 0.0,	-- Maximum revolt risk at the maximum revolt risk happiness

		WAS_PURGED_LENGTH_DAYS				= 7300,	-- Number of days after purging a pop is angry for being genocided
		...
		BASE_HAPPINESS					= 0.5,  -- Base value of pop happiness
	...
	NEconomy = {
		...
		COLONY_MONTHLY_GROWTH				= 1.0,	-- How much the colonization pop grows every month.
		...
		TERRAFORM_STATION_MAINENANCE		= 3.0,		-- Monthly terraform station maintenance
		...
		OUTPOST_STATION_INFLUENCE_MAINTENANCE = 0.1,	-- Monthly outpost station Influence maintenance
	...
	NAI = {
		...
		THREAT_SHARED_THREAT_REDUCTION = 4,		
		...
		MAX_RESOURCE_SCORE_DIV = 10000,			-- Resources that aren't critical prio are divided by this amount
		...
		TRADE_VALUE_RESOURCE_INCOME_BASE = 0.5,	-- for minerals and energy
		...
		EXPECTED_TECH_BASE = 20,						-- AI expects to make this base amount in tech
		...
		EXPECTED_ENERGY_SURPLUS = 5,				-- AI wants a surplus of least this amount in monthly energy production (temporary spending such as colonies does not count)
		...
		FLEET_BALANCE_THREAT = 0.7,				-- If FleetPower of AI / FleetPower of Enemy is lower than this, AI will consider the country a threat
		...
		ENEMY_NEUTRALS_FLEET_POWER_MULT = 1.2,	-- AI will need the the fleet power of the enemy multiplied by this value to attack neutrals and space hostiles
		...
		INFLUENCE_MULT = 25,						-- Used to calc AI want for buildings with influence
		BUILDING_PRODUCTION_MAX = 5000,			-- Used to calc AI want for buildings with production points
		POP_FOOD_MIN = 25,						-- AI should always prioritize to get more food when planet food tot is below this value
	...
	--	COLONIZE_HABITABILITY_MIN = 0.40,		-- Planet habitability must be at least this value in order for AI to colonize
		...
		SECTOR_IGNORE_TILE_RESOURCE = 1,		-- Should sectors ignore which resources are on the tile when building?
